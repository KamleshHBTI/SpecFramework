Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/KamleshHBTI/SpecFramework.git"
  ...
  s.platform     = :ios
  s.source       = { :git => "https://github.com/KamleshHBTI/SpecFramework.git", :tag => s.version}

  s.source_files = "SpecFramework", "SpecFramework/**/*.{h,m,swift}"
  s.requires_arc            = true
